...
export const loanProviders: Provider[] = [
  ...
  },
  {
    ...
    name: 'Nordea',
    category: 'loans',
    logo: 'https://upload.wikimedia.org/wikipedia/commons/7/7b/Nordea_logo_2023.svg',
    price: 3.25,
    priceUnit: '% interest',
    rating: 4.5,
  ...
  },
  {
    ...
    name: 'Santander',
    category: 'loans',
    logo: 'https://upload.wikimedia.org/wikipedia/commons/4/4b/Santander_Logo.svg',
    price: 3.40,
    priceUnit: '% interest',
    rating: 4.2,
  ...
  },
  {
    ...
    name: 'Komplett Bank',
    category: 'loans',
    logo: 'https://upload.wikimedia.org/wikipedia/commons/f/f9/Komplett_Bank_logo.svg',
    price: 3.60,
    priceUnit: '% interest',
    rating: 4.0,
  ...
  },
  {
    ...
    name: 'Instabank',
    category: 'loans',
    logo: 'https://upload.wikimedia.org/wikipedia/commons/e/eb/Instabank_logo.svg',
    price: 3.55,
    priceUnit: '% interest',
    rating: 4.1,
  ...
  },
  {
    ...
    name: 'Bank Norwegian',
    category: 'loans',
    logo: 'https://upload.wikimedia.org/wikipedia/commons/9/9a/Bank_Norwegian_logo.svg',
    price: 3.50,
    priceUnit: '% interest',
    rating: 4.3,
  ...
  },
  {
    ...
    name: 'yA Bank',
    category: 'loans',
    logo: 'https://upload.wikimedia.org/wikipedia/commons/9/94/YA_Bank_logo.svg',
    price: 3.65,
    priceUnit: '% interest',
    rating: 4.0,
  ...
  },
  {
    ...
    name: 'Svea Finans',
    category: 'loans',
    logo: 'https://upload.wikimedia.org/wikipedia/commons/d/d5/Svea_Finans_logo.svg',
    price: 3.70,
    priceUnit: '% interest',
    rating: 3.9,
  ...
  },
  {
    ...
    name: 'BN Bank',
    category: 'loans',
    logo: 'https://upload.wikimedia.org/wikipedia/commons/7/7f/BN_Bank_logo.svg',
    price: 3.20,
    priceUnit: '% interest',
    rating: 4.4,
  ...
  },
  {
    ...
    name: 'Ikano Bank',
    category: 'loans',
    logo: 'https://upload.wikimedia.org/wikipedia/commons/0/04/Ikano_Bank_logo.svg',
    price: 3.45,
    priceUnit: '% interest',
    rating: 4.1,
